...
public class AttackCubeController : MonoBehaviour
{
    public string AttackCubeTag = "AttackTag";
    public Sprite attackcube;
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (hit.collider.gameObject.CompareTag(AttackCubeTag))
                {
